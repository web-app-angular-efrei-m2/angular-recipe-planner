...
@Component({
  ...
  template: `
    <div class="relative flex flex-1 flex-col h-[calc(100dvh-97px)] wrap-break-word rounded-sm text-start font-semibold text-gray-400">
      <!-- navigation buttons  -->
      ...
      <div class="max-w-5xl mx-auto w-dvw">
        ...
        <div class="flex flex-col px-6">
           <a [routerLink]="['/recipes', recipeId(), 'review', 'new']" class="btn btn-lg btn-ghost justify-start gap-2 rounded-xl font-semibold text-gray-500 bg-gray-100 border-0">
        ...
        <!-- review list  -->
        <div class="flex flex-1 flex-col wrap-break-word text-start px-6 py-4">
          <div class="sticky top-(--header-height) flex items-center justify-between pb-2 bg-white">
            <h3 class="text-sm text-gray-800 font-semibold">User reviews</h3>
            <button class="tooltip tooltip-left tooltip-animated btn btn-xs btn-link text-gray-800 cursor-default" data-tip="Coming soon - Feature not yet implemented">
